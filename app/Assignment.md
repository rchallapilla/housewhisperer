> **Note**: This file contains assignment instructions for an AI-Assisted Development Workflow course. It is **not related** to the House Whisperer frontend application in this repository. It is kept here for reference as it was part of the learning process that led to building this project.
